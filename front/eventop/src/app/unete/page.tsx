  ...
  return (
    <div className="h-6xl bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
      <section className="text-center mb-12">
        <h2 className="text-4xl font-extrabold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 text-center">¿Cómo funciona?</h2>
        ...
        <div className="flex flex-row flex-wrap justify-around max-h-2xl max-w-6xl gap-8">
          {!userName && (
            <div className="bg-gray-800 p-6 rounded-lg shadow-md space-y-4 max-w-xs mx-auto border border-gray-700">
              <h3 className="text-2xl font-semibold text-white mb-2">Crea tu cuenta</h3>
              <p className="text-gray-400 text-md">Regístrate para comenzar a usar la plataforma</p>
              <button
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-md space-y-4 max-w-xs mx-auto border border-gray-700">
            <h3 className="text-2xl font-semibold text-white mb-2">1. Solicita ser creador</h3>
            <p className="text-gray-400 text-md">Solicita permisos para crear eventos</p>
          </div>
          <div className="bg-gray-800 p-6 rounded-lg shadow-md space-y-4 max-w-xs mx-auto border border-gray-700">
            <h3 className="text-2xl font-semibold text-white mb-2">2. Crea tu evento</h3>
            <p className="text-gray-400 text-md">Configura los detalles de tu evento en minutos</p>
          </div>
          <div className="bg-gray-800 p-6 rounded-lg shadow-md space-y-4 max-w-xs mx-auto border border-gray-700">
            <h3 className="text-2xl font-semibold text-white mb-2">3. Personaliza tickets</h3>
            <p className="text-gray-400 text-md">Define tipos de entradas y precios a tu medida</p>
          </div>
          <div className="bg-gray-800 p-6 rounded-lg shadow-md space-y-4 max-w-xs mx-auto border border-gray-700">
            <h3 className="text-2xl font-semibold text-white mb-2">4. ¡Publica!</h3>
            <p className="text-gray-400 text-md">Comparte y vende tickets al instante</p>
          </div>
        </div>
      </section>
      <h1 className="text-3xl font-extrabold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 text-center">Únete a Nosotros</h1>
      <form onSubmit={handleSubmit} className="bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-6xl space-y-6">
