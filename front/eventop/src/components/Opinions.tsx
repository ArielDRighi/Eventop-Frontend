                  ...
                  <div className="h-full bg-gradient-to-br from-purple-900 to-purple-800 p-8 rounded-2xl shadow-2xl border border-purple-700/30 backdrop-blur-sm transition-all duration-300 hover:shadow-purple-500/10 hover:-translate-y-1 flex flex-col justify-between">
                    <div className="text-left">
                      <svg
                        ...
                        fill="currentColor"
                        className="block w-8 h-8 text-purple-400 mb-6"
                    ...
                    <div className="flex-grow">
                      <p
                        className={`leading-relaxed mb-8 text-gray-300 text-lg ${
        ...
        <section className="bg-gradient-to-br from-purple-900 to-purple-800 rounded-2xl shadow-2xl p-8 border border-purple-700/30">
          ...
          <div className="prose prose-purple">
            <p className="text-gray-300 text-lg mb-6">
              Entendemos que los planes pueden cambiar. Nuestra política está
              diseñada para ser justa tanto para los asistentes como para los
            ...
            {policyExpanded && (
              <ul className="mt-6 space-y-3 text-gray-300 font-sans list-none">
                <li>
                  Reembolso completo disponible hasta 7 días antes del evento.
                </li>
                <li>
                  50% de reembolso disponible entre 7 días y 48 horas antes del
                  evento.
                </li>
                <li>
                  No se ofrecen reembolsos dentro de las 48 horas previas al
                  evento.
                </li>
                <li>
                  Los cambios de fecha están sujetos a disponibilidad y pueden
                  incurrir en una tarifa de gestión.
                </li>
                <li>
                  En caso de cancelación del evento por parte del organizador,
