            ...
            <div className="text-center lg:text-left">
              <div className="flex flex-col items-center justify-center lg:items-start">
                <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:leading-none lg:mt-6 lg:text-5xl xl:text-6xl">
                  <p className="sm:block">Publica</p>
                  <span className="text-white md:block">tus eventos en</span>
            ...
            <section className="relative py-6 sm:py-10 lg:py-24 w-full">
              <div className="px-4 mx-auto sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-2xl mx-auto text-center">
                  <h2 className="text-3xl sm:text-4xl text-white font-extrabold mx-auto md:text-5xl lg:text-5xl">
                    ¿Cómo funciona?
                  </h2>
                ...
                <div className="relative mt-8 sm:mt-12 lg:mt-20">
                  ...
                  <div
                    className="relative grid grid-cols-1 text-center gap-y-6 
                  ...
                  >
                    <div>
                      ...
                      <h3 className="mt-4 sm:mt-6 text-lg sm:text-xl text-white font-semibold leading-tight md:mt-10">
                        Crea tu evento
                      </h3>
                    ...
                    <div>
                      ...
                      <p className="mt-4 text-base text-gray-400 md:text-lg">Comparte y vende tickets al instante</p>
                    </div>
                  </div>
                </div>
              </div>
              <div
                className="absolute inset-0 m-auto max-w-xs h-[257px] sm:h-[357px] blur-[118px] sm:max-w-md md:max-w-lg"
                style={{
                  background:
